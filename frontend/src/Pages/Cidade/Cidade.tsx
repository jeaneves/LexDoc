    ...
    return(
        <section>
            ...
            <div className="flex justify-between items-center flex-wrap mb-4">
                <h2 className="text-2xl font-bold text-gray-800">Cidades</h2>
                <Button type="button" color="green" onClick={() => {}} >Cadastrar</Button>
            </div>
            {/* Filtros */}            
            ...
            <div className="hidden lg:block text-sm">
                <table className="w-full border-collapse">
                    <thead className="border-b">
                        <tr>
                            <th className="text-left py-2 pr-2 w-6/12"> Nome </th>
                            <th className="text-left py-2 pr-2 w-2/12"> UF</th>
                            <th className="text-left py-2 pr-2 w-2/12"> Ação</th>
                        </tr>
                    </thead>
                    <tbody>
